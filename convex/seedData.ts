...
export const TAGS_GLOSSARY = {
  ...
  purpose: [
    ...
    "activation",     // Muscle activation / movement prep
  ],
...
export const EXERCISES = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // WARMUP PROTOCOL EXERCISES
  // Organized by warmup phase: foam rolling → mobility → core → walking → movement prep → power
  // ─────────────────────────────────────────────────────────────────────────────

  // --- Foam Rolling (8 exercises) ---
  {
    name: "Foam Roll Quads",
    slug: "foam_roll_quads",
    tags: ["lower_body", "foam_rolling", "warmup", "quad_dominant"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Lie face down with foam roller under your thighs. Roll from just above the knee to the hip flexor, pausing on tender spots for 10-15 seconds.",
  },
  {
    name: "Foam Roll Hamstrings",
    slug: "foam_roll_hamstrings",
    tags: ["lower_body", "foam_rolling", "warmup", "hamstring"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Sit with foam roller under the back of your thighs. Roll from just above the knee to the glute. Cross one leg over the other for more pressure.",
  },
  {
    name: "Foam Roll IT Band",
    slug: "foam_roll_it_band",
    tags: ["lower_body", "foam_rolling", "warmup", "frontal"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Lie on your side with foam roller under your outer thigh. Roll from just above the knee to the hip. Support yourself with your top leg to control pressure.",
  },
  {
    name: "Foam Roll Calves",
    slug: "foam_roll_calves",
    tags: ["lower_body", "foam_rolling", "warmup"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Sit with foam roller under your calves. Roll from the ankle to just below the knee. Cross one leg over the other for more pressure.",
  },
  {
    name: "Foam Roll Glutes",
    slug: "foam_roll_glutes",
    tags: ["lower_body", "foam_rolling", "warmup", "glute"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Sit on the foam roller with one ankle crossed over the opposite knee. Lean toward the crossed side and roll through the glute.",
  },
  {
    name: "Foam Roll Thoracic Spine",
    slug: "foam_roll_thoracic",
    tags: ["upper_body", "foam_rolling", "warmup", "thoracic"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Lie on your back with foam roller under your upper back. Cross arms over chest. Slowly roll from mid-back to upper back, extending over the roller at tight spots.",
  },
  {
    name: "Foam Roll Lats",
    slug: "foam_roll_lats",
    tags: ["upper_body", "foam_rolling", "warmup", "back"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Lie on your side with foam roller under your armpit area. Roll from mid-rib to armpit along the lat muscle. Keep thumb pointing up.",
  },
  {
    name: "Foam Roll Adductors",
    slug: "foam_roll_adductors",
    tags: ["lower_body", "foam_rolling", "warmup", "hip"],
    equipment: ["foam_roller"],
    difficulty: "beginner" as const,
    instructions: "Lie face down with one leg out to the side. Place foam roller under the inner thigh. Roll from knee to groin, pausing on tight spots.",
  },

  // --- Mobility (6 new exercises, plus existing: worlds_greatest_stretch, 90_90_hip_stretch, cat_cow, hip_flexor_stretch, thoracic_rotation) ---
  {
    name: "Ankle Circles",
    slug: "ankle_circles",
    tags: ["lower_body", "mobility", "warmup", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Stand on one foot (hold wall for balance). Circle the raised ankle slowly in both directions. 10 circles each direction per ankle.",
  },
  {
    name: "Hip Circles",
    slug: "hip_circles",
    tags: ["lower_body", "mobility", "warmup", "hip", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Stand on one foot. Lift the opposite knee and draw large circles with the knee. 10 circles each direction per leg.",
  },
  {
    name: "Arm Cross-Body Stretch",
    slug: "arm_cross_body_stretch",
    tags: ["upper_body", "mobility", "warmup", "shoulder"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Pull one arm across your body at chest height using the opposite hand. Hold briefly, then switch. Dynamic version: sweep arm across and back.",
  },
  {
    name: "Shoulder Pass-Through",
    slug: "shoulder_pass_through",
    tags: ["upper_body", "mobility", "warmup", "shoulder", "shoulder_health"],
    equipment: ["band"],
    difficulty: "beginner" as const,
    instructions: "Hold a band or dowel with a wide grip. Keeping arms straight, slowly arc it from front to behind your back and return. Narrow grip as mobility improves.",
  },
  {
    name: "Inchworm",
    slug: "inchworm",
    tags: ["full_body", "mobility", "warmup", "dynamic", "hamstring"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "From standing, fold forward and walk hands out to a plank position. Pause, then walk feet up to hands. Stand and repeat.",
  },
  {
    name: "Scorpion Stretch",
    slug: "scorpion_stretch",
    tags: ["full_body", "mobility", "warmup", "hip", "thoracic", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Lie face down with arms out to the sides. Lift one leg and rotate it across your body toward the opposite hand. Alternate sides.",
  },

  // --- Core Isometric (4 new exercises, plus existing: dead_bug, plank, bird_dog) ---
  {
    name: "Hollow Body Hold",
    slug: "hollow_body_hold",
    tags: ["core", "isometric", "warmup", "anti_extension", "stability"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Lie on your back. Press lower back into the floor. Lift shoulders and legs slightly off the ground, arms by ears. Hold with core tight.",
  },
  {
    name: "Bear Crawl Hold",
    slug: "bear_crawl_hold",
    tags: ["core", "isometric", "warmup", "stability", "full_body"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Start on all fours. Lift knees 1-2 inches off the ground. Hold this position keeping back flat and core braced. Breathe steadily.",
  },
  {
    name: "Tall Kneeling Pallof Hold",
    slug: "tall_kneeling_pallof_hold",
    tags: ["core", "isometric", "warmup", "anti_rotation", "stability"],
    equipment: ["band"],
    difficulty: "beginner" as const,
    instructions: "Kneel tall with a band anchored to the side. Press hands out at chest height and hold. Resist the band pulling you into rotation.",
  },
  {
    name: "Quadruped Belly Lift",
    slug: "quadruped_belly_lift",
    tags: ["core", "isometric", "warmup", "stability"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Start on all fours. Exhale fully, drawing belly button in. Lift knees slightly off the floor. Hold for 5 breaths. Focus on deep core activation.",
  },

  // --- Core Dynamic (4 exercises) ---
  {
    name: "Bicycle Crunch",
    slug: "core_bicycle",
    tags: ["core", "warmup", "rotation", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Lie on your back with hands behind head. Alternate bringing elbow to opposite knee while extending the other leg. Controlled, not fast.",
  },
  {
    name: "Bird Dog Crunch",
    slug: "bird_dog_crunch",
    tags: ["core", "warmup", "anti_rotation", "dynamic", "coordination"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "From bird dog position (opposite arm and leg extended), bring elbow and knee together under your body, then extend back out. Alternate sides.",
  },
  {
    name: "Glute Bridge March",
    slug: "glute_bridge_march",
    tags: ["core", "warmup", "glute", "activation", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Hold a glute bridge position. Lift one foot off the ground bringing knee toward chest, then set it down and switch. Maintain level hips throughout.",
  },
  {
    name: "Dead Bug with Reach",
    slug: "dead_bug_with_reach",
    tags: ["core", "warmup", "anti_extension", "dynamic", "coordination"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Lie on your back with arms reaching to ceiling, knees at 90°. Extend opposite arm overhead and opposite leg out. Return and switch sides.",
  },

  // --- Walking Drills (8 exercises) ---
  {
    name: "Heel-Toe Walk",
    slug: "heel_toe_walk",
    tags: ["lower_body", "warmup", "activation", "balance", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Walk forward placing heel directly in front of toes with each step, like walking on a balance beam. Arms out for balance.",
  },
  {
    name: "Walking Knee Hug",
    slug: "walking_knee_hug",
    tags: ["lower_body", "warmup", "mobility", "hip", "dynamic", "glute"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Walk forward, pulling each knee to chest with both hands. Rise onto the ball of your standing foot. Alternate legs with each step.",
  },
  {
    name: "Walking Quad Stretch",
    slug: "walking_quad_stretch",
    tags: ["lower_body", "warmup", "mobility", "quad_dominant", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Walk forward, grabbing your ankle behind you to stretch the quad with each step. Rise onto toes of standing foot. Alternate legs.",
  },
  {
    name: "Walking Cradle Stretch",
    slug: "walking_cradle_stretch",
    tags: ["lower_body", "warmup", "mobility", "hip", "glute", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Walk forward, lifting one shin and cradling it with both hands at shin and ankle. Pull gently toward chest. Alternate sides.",
  },
  {
    name: "Walking RDL Reach",
    slug: "walking_rdl_reach",
    tags: ["lower_body", "warmup", "hinge", "hamstring", "balance", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Walk forward performing a single-leg RDL with each step, reaching toward the ground with opposite hand. Stand tall between reps.",
  },
  {
    name: "Walking Spiderman",
    slug: "walking_spiderman",
    tags: ["full_body", "warmup", "mobility", "hip", "thoracic", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Step into a deep lunge position, place both hands on the ground, then rotate the lead-side arm toward the ceiling. Step through and repeat on the other side.",
  },
  {
    name: "Lateral Shuffle",
    slug: "lateral_shuffle",
    tags: ["lower_body", "warmup", "agility", "frontal", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "In an athletic stance, shuffle sideways keeping feet wide and hips low. Don't let feet touch. Reverse direction at the end.",
  },
  {
    name: "Walking Lunge with Rotation",
    slug: "walking_lunge_rotation",
    tags: ["full_body", "warmup", "mobility", "lunge", "rotation", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Step into a walking lunge. At the bottom, rotate your torso over the front leg. Return to center, stand, and step with the other leg.",
  },

  // --- Movement Prep (8 exercises) ---
  {
    name: "Jog",
    slug: "jog",
    ...
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Light jog at conversational pace. Focus on relaxed shoulders, quick turnover, and landing softly.",
  },
  {
    name: "Carioca",
    slug: "carioca",
    tags: ["full_body", "warmup", "agility", "frontal", "coordination", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Move sideways crossing one foot in front, then behind. Rotate hips while keeping shoulders square. Arms swing naturally.",
  },
  {
    name: "Skip",
    slug: "skip",
    tags: ["full_body", "warmup", "dynamic", "coordination"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Basic skipping motion emphasizing height and arm swing. Drive knee up with each skip. Stay light on your feet.",
  },
  {
    name: "Power Skip",
    slug: "power_skip",
    tags: ["full_body", "warmup", "power", "explosive", "dynamic"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Exaggerated skipping for maximum height. Drive knee explosively upward while swinging opposite arm. Focus on triple extension.",
  },
  {
    name: "A-Skip",
    slug: "a_skip",
    tags: ["full_body", "warmup", "dynamic", "coordination", "activation"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Skip forward driving one knee up to hip height with each bound. Quick ground contact. Arms pump in opposition. Maintain upright posture.",
  },
  {
    name: "B-Skip",
    slug: "b_skip",
    tags: ["full_body", "warmup", "dynamic", "coordination", "hamstring", "activation"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Like A-skip but extend the leg out at the top, then paw it back to the ground. Develops hamstring activation and sprint mechanics.",
  },
  {
    name: "High Knees Drill",
    slug: "high_knees_drill",
    tags: ["full_body", "warmup", "dynamic", "conditioning", "activation"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Run in place driving knees to hip height with each step. Stay on balls of feet. Quick arm pump. Maintain tall posture.",
  },
  {
    name: "Butt Kicks",
    slug: "butt_kicks",
    tags: ["lower_body", "warmup", "dynamic", "hamstring", "activation"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Jog forward kicking heels up to touch your glutes with each stride. Quick cadence. Arms pump naturally.",
  },

  // --- Power Primer (7 exercises) ---
  {
    name: "Med Ball Chest Pass",
    slug: "med_ball_chest_pass_warmup",
    tags: ["upper_body", "warmup", "power", "explosive", "push", "chest"],
    equipment: ["medicine_ball", "wall"],
    difficulty: "beginner" as const,
    instructions: "Stand facing a wall. Hold med ball at chest. Explosively push the ball into the wall, catch on return. Focus on quick release.",
  },
  {
    name: "Med Ball Overhead Throw",
    slug: "med_ball_overhead_throw_warmup",
    tags: ["full_body", "warmup", "power", "explosive", "shoulder"],
    equipment: ["medicine_ball"],
    difficulty: "beginner" as const,
    instructions: "Stand tall holding med ball overhead. Slam it down to the ground with full-body extension. Pick up and repeat.",
  },
  {
    name: "Med Ball Rotational Pass",
    slug: "med_ball_rotational_pass",
    tags: ["core", "warmup", "power", "rotation", "explosive"],
    equipment: ["medicine_ball", "wall"],
    difficulty: "beginner" as const,
    instructions: "Stand sideways to a wall. Rotate and throw the med ball into the wall explosively. Catch and repeat. Switch sides.",
  },
  {
    name: "Broad Jump (Warmup)",
    slug: "broad_jump_warmup",
    tags: ["lower_body", "warmup", "power", "explosive", "plyometric", "horizontal"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "From standing, swing arms and jump forward for distance. Land softly with bent knees. Walk back and repeat. Keep volume low — this is activation, not training.",
  },
  {
    name: "Vertical Jump (Warmup)",
    slug: "vertical_jump_warmup",
    tags: ["lower_body", "warmup", "power", "explosive", "plyometric", "vertical"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "From standing, dip and jump straight up for maximum height. Land softly. Reset fully between reps. Focus on explosive intent.",
  },
  {
    name: "Box Jump (Warmup)",
    slug: "box_jump_warmup",
    tags: ["lower_body", "warmup", "power", "explosive", "plyometric"],
    equipment: ["plyo_box"],
    difficulty: "beginner" as const,
    instructions: "Face a box at moderate height. Swing arms and jump onto the box landing softly. Step down (don't jump). Reset between reps.",
  },
  {
    name: "Explosive Push-Up (Warmup)",
    slug: "explosive_pushup_warmup",
    tags: ["upper_body", "warmup", "power", "explosive", "push", "chest"],
    equipment: ["bodyweight"],
    difficulty: "beginner" as const,
    instructions: "Perform a push-up with enough force that your hands leave the ground at the top. Land softly and immediately lower into the next rep. Scale to knees if needed.",
  },
